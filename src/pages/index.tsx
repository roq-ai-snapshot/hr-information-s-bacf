  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With HR Information System, take control of your workforce management. Handle employee data, vacations, and payroll all in one convenient place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With HR Information System, take control of your workforce management. Handle employee data, vacations, and payroll all in one convenient place.`}
            </Text>
            <Box
